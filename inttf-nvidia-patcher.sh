...
function usage {
  ...
  echo "script usage: $(basename $0) [-h] [-v 340.108, 390.157, 418.113, 435.21, 470.239.06] [-d opensuse-leap]" >&2
}
...
nvidia_versions=( '340.108' '390.157' '418.113' '435.21' '470.239.06' )
...
nvidia_470xx_b2sum="556c8f7058b83d8c4c7ccb2f62619ac001f7c3868b80ee091e2949fb7b35e136fec83c15efcf4dd4c99d312f8c36f83c76e250d18d091e053355396b8347af11"
...
case "${nvidia_short_ver}" in
  340)
    case "${distro}" in
      ...
      *)
        ...
        output_file_name=( 'patched-kernel-6.8' 'patched for kernel 6.8+' )
        ;;
    esac
    ;;
  390)
  ...
  470)
    ...
    patch_file_b2sums=(
      ...
      '5375cbf40e1974708fa78aa230a115a837086207794aba4a6acd0edb034d4e076df6c402a8372082d62a44853aa14b941a5a55a940fadf2a7947713bc6c78839' )
    output_file_name=( 'patched-kernel-6.8' 'patched for Kernel 6.8+' )
    ;;
esac
